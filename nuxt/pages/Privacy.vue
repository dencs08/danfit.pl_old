<template>
    <main>
        <section class="my-20 lg:my-32">
            <div class="container">
                <h3 class="mb-4 sm:mb-0">Polityka prywatności <TextGradient>{{ name }}</TextGradient>
                </h3>
                ...
                <div class="space-y-8">
                    <p>
                        ...
                        użytkowników i odwiedzających, które zbieramy, używamy,
                        ujawniamy i zarządzamy poprzez używanie Strony
                        {{ name }} (“<strong>Strony</strong>”).<br />
                        Poprzez używanie Strony, zgadzasz się w pełni na warunki
                    ...
                    <p>
                        ...
                        Możemy używać ciasteczek, web beacon’ów i innych technologii
                        śledzących na tej Stronie, które domyślnie są ustawione na
                        akceptację ich ciasteczek, w celu polepszenia doświadczenia
                        online dla naszych klientów. Musisz być świadomym tego, że
                        zablokowanie ciasteczek lub web beacon’ów może wpłynąć na
                    ...
                    <p>
                        ...
                        Przyjmujesz do wiadomości, że ta polityka prywatności jest
                        obiektem modyfikacji, alternacji i poprawek przez
                        {{ name }} przez cały czas, bez lub z powiadomieniem Ciebie o
                        nich. Zgadzasz się również z tym, że jakiekolwiek modyfikacje są
                        w ważne i mają wpływ po ich zamieszczeniu w tej Witrynie.
                    </p>
                </div>
            </div>
        </section>
