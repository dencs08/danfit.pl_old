<template>
    <button class="btn rounded-full text-white-primary font-semibold" :class="['btn-' + styling, 'btn-' + size]">
        <slot></slot>
    </button>
</template>
...
.btn {
    padding-top: clamp(1em, 0.9vw, 1.5em);
    padding-right: clamp(1.75em, 2vw, 2.5em);
    padding-bottom: clamp(1em, 0.9vw, 1.5em);
